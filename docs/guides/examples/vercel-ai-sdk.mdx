...
The Vercel AI SDK also supports OpenAI-compatible providers like [AI Badgr](/guides/examples/ai-badgr-openai-compatible) (Budget/Utility) using the same interface.
